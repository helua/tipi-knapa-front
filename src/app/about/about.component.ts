...
export class AboutComponent implements OnInit {
  ...
  abouts: string[] = [
    'Podczas wojażu po Polsce z moim przyjacielem <i>Łukaszem</i> zatrzymaliśmy się na obiad u jego rodziców. Tak poznałem <i>Rycha</i>. Jakiś czas potem Łukasz zrobił w domu kilka noży z piły tarczowej, które przywiózł na Grochów razem z pewną historią. Otóż Rychu zaskoczony faktem, że da się taki nóż wykonać własnoręcznie (i to w domowych warunkach), zaczął sam bawić się w swoim warsztacie… a reszta to historia. Mniej więcej w tym samym czasie logo TipiKnapa wylądowało na okładce albumu „Knurion"- pierwszym z wielu albumów, do których okładki robiliśmy razem z Łukaszem. Od tamtego czasu planowałem wrzucić na rynek własny produkt. Minęły cztery lata zanim połączyłem te kropki.',
